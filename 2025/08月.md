...
# 8.19 Tue
* 61.开源版Genie 3世界模型来了：实时+长时间交互，单卡可跑，国内公司出品  机器之心  https://mp.weixin.qq.com/s/Bgf7-1BUyIW0awIJOYHVsQ \
  昆仑万维发布的交互世界模型「Matrix-Game 2.0」，它的参数量仅有 1.8B，能跑在单块 GPU 上，生成的虚拟环境帧率能达到 25FPS，我们在其中可以用键盘 WASD 按键进行实时的自由移动和视角控制，实现持续时长达分钟级的互动 \
  项目链接：https://matrix-game-v2.github.io/GitHub  \
  链接：https://github.com/SkyworkAI/Matrix-Game \
...
* 62.（**值得看看**）强化学习之父Richard Sutton最新演讲揭示OaK架构：通向超级智能的八步愿景  机器之心  https://mp.weixin.qq.com/s/PVOaXQLr2rE5icesKV1Qog \
...
* 63.RL推理的尽头，是熵坍缩？统一SFT与强化学习的新视角  机器学习研究组订阅  https://mp.weixin.qq.com/s/6M80SqxA6XcbvcYCK1EXzQ \

# 8.20 Wed
* 64.ICCV 2025满分论文！空间理解与主动探索大统一，MTU3D重塑AI具身导航范式  PaperWeekly  https://mp.weixin.qq.com/s/cqNZz2XBGQ9iwDKfmpBvcg \
  Move to Understand a 3D Scene: Bridging Visual Grounding and Exploration for Efficient and Versatile Embodied Navigation \
  https://mtu3d.github.io/ \
  https://github.com/MTU3D/MTU3D
* 65.深刻理解Token：大语言模型（LLM）是如何看待这世界？  AINLPer  https://mp.weixin.qq.com/s/h0Do-deRvCoJeqPII4aXRw \
  BPE、WordPiece、SentencePiece、Unigram、
* 66.突破Agent长程推理效率瓶颈！MIT&新加坡国立联合推出强化学习新训练方法  量子位  https://mp.weixin.qq.com/s/aLq93YFNY2e9-AJ0xyJ1eQ \
  MEM1框架 \
  提出了一种基于强化学习的推理方案，通过让智能体学会将记忆更新作为上下文的一部分，从而实现近似常量级的显存开销（near constant memory） \
