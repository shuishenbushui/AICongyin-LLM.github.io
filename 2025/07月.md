...
* 98.标六万字长文一次性说清LLM的后训练技术题  图灵人工智能  https://mp.weixin.qq.com/s/epFv8gp6zeCH-S8yh634vg \
...
* 119.1.5B刷新数学代码SOTA！快手&清华精细化Token管理，LLM推理能力飙升  量子位  https://mp.weixin.qq.com/s/HkmsXxe97EtL8G10t77giA \
  Stabilizing Knowledge, Promoting Reasoning: Dual-Token Constraints for RLVR \
  https://github.com/wizard-III/ArcherCodeR \
  秘密在于给模型的“学习过程”做了精细化管理：让该记牢的知识稳住，让该灵活的推理放开  \
  低熵token 高熵token 
* 120.Qwen全面升级非思考模型，3B激活、256K长文、性能直逼GPT-4o  量子位  https://mp.weixin.qq.com/s/QJRAPmBC52PqnBfIEj6LVQ 
* 121.腾讯发布混元3D世界模型1.0：首个支持物理仿真的开源世界生成系统  量子位  https://mp.weixin.qq.com/s/zJlHbrsQmwjPLRnqu2HLjA \
  混元3D世界模型1.0（HunyunWorld-1.0）是融合两类方法(视频驱动、三维驱动)优势的创新框架，能够依据文本或图像输入生成沉浸式、可探索、可交互的3D场景

# 7.31 Thur
* 122.自进化智能体综述：通往人工超级智能之路  专知  https://mp.weixin.qq.com/s/gxbtT-KqDjpXIptpAaYn5g \
  A SURVEY OF SELF-EVOLVING AGENTS: ON PATH TO ARTIFICIAL SUPER INTELLIGENCE \
  https://github.com/CharlesQ9/Self-Evolving-Agents
* 123.VLA-OS：NUS邵林团队探究机器人VLA做任务推理的秘密  机器之心  https://mp.weixin.qq.com/s/fybwGyyU5ceXgllenI8lAA \
  VLA-OS: 首次系统性地解构和分析了机器人 VLA 模型进行任务规划和推理，进行了任务规划表征与模型范式的统一对比。这项工作通过系统、可控、详细的实验对比，不仅为研究者提供了翔实的研究成果，更为下一代通用机器人 VLA 模型指明了方向 \
  VLA-OS: Structuring and Dissecting Planning Representations and Paradigms in Vision-Language-Action Models \
  https://nus-lins-lab.github.io/vlaos/
* 124.ACL'25最佳论文独家解读：大模型有「抗改造」基因，现有后训练范式失灵预警  机器之心  https://mp.weixin.qq.com/s/mJeTtjgHT6YlNIFxyOFphw \
  Language Models Resist Alignment: Evidence From Data Compression \
  https://pku-lm-resist-alignment.github.io
* 125.RL推理的尽头，是熵坍缩？统一SFT与强化学习的新视角  PaperWeekly  https://mp.weixin.qq.com/s/Vn0rHFJWbnORdnb2bxvp3Q
* 126.RL Scaling大时代来临！siiRL首创全分布式框架，千卡强化学习训练轻松跑通  PaperWeekly  https://mp.weixin.qq.com/s/e4nA3A7x3BPtSABklSNFjg
* 127.对比Adam，为什么选择Muon？Muon优化器优化原理深度解析及最新思考  吃果冻不吐果冻皮  https://mp.weixin.qq.com/s/Rlnlbe-yN4Pij_FJUMQ0YQ
