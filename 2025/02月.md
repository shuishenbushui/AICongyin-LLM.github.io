...
# 2.28 Fri
* 180.DeepMind首席科学家最新万字访谈：模型「慢思考」，能力大幅提升！ 
 Datawhale  https://mp.weixin.qq.com/s/a4Vlw4TjKERDk3wuNJoDNw \
  “延长上下文、加速运算、降低成本”这一循环过程将持续推进
* 181.2万字长文！一文了解Attention，从MHA到DeepSeek MLA，大量图解，非常详细！  AINLPer  https://mp.weixin.qq.com/s/VKoOyjfilL5ZSxN24WdlBA 
* 182.超越DeepSeek推理，效率更高！斯坦福马腾宇新作：有限数据，无限迭代 
 新智元  https://mp.weixin.qq.com/s/kUXsI4ojeaOIMClZqlNjEg \
  STP（自博弈定理证明器）让模型扮演「猜想者」和「证明者」，互相提供训练信号，在有限的数据下实现了无限自我改进，在Lean和Isabelle验证器上的表现显著优于现有方法，证明成功率翻倍，并在多个基准测试中达到最先进的性能 \
  STP: Self-play LLM Theorem Provers with IterativeConjecturing and Proving \
  强化学习和专家迭代都存在一个严重问题：通过率（pass rate）过低，对「未证明的定理」生成「正确证明」所需的样本量呈指数级增长，大量的计算资源被浪费在生成错误的证明上，无法为模型提供训练信号 \
  强化学习从原理上就受到训练数据集中「定理难度水平」的限制，一个模型不可能从「解决高中水平的问题」中学习到「大学水平的证明技巧」，也无法解决「开放性」的数学问题，需要持续收集高水平的定理命题和数学问题 \
...
* 183.机器人诞生「运动自我意识」，哥大华人登Nature子刊：照镜子学会自我建模  新智元  https://mp.weixin.qq.com/s/iA17LxDivvPsFjHfMKiIPg \
  让机器人获得了「自我学习」能力：仅凭普通摄像头，就能像孩子观察自己的手脚般理解身体构造，甚至在「受伤」时自主调整和恢复 \
  ...
  机器人利用「FFKSM」（Free Form Kinematic Self-Model）技术，可以实现：1.观察自己，理解身体的形态和运动方式。2.规划自己的动作，无需预设物理引擎或仿真。3.在受损后自我修正，比如如果手臂弯曲，机器人能识别变化并调整行动，而不需要工程师重新编程。
* 184.Karpathy更新AI科普视频，网友：原本周末打算结个婚，改看视频了  机器之心  https://mp.weixin.qq.com/s/YyTWbxYzAWIl3Q2FF0KMZg \
  「我是如何使用大型语言模型（LLM）的」 \
  https://www.youtube.com/watch?v=EWvNQjAaOHw
* 185.DeepSeek开源周最后一天：让数据处理「从自行车升级到高铁」  机器之心  https://mp.weixin.qq.com/s/p8KGnYIqmCkXPF4jjRiKjQ \
  今天他们开源了一个名为 3FS（Fire-Flyer File System）的系统。这是一种并行文件系统，它利用现代固态硬盘（SSD）和远程直接内存访问（RDMA）网络的全部带宽，能够加速和推动 DeepSeek 平台上所有数据访问操作。 \
  开源链接：https://github.com/deepseek-ai/3FSSmallpond（3FS 上的数据处理框架）：https://github.com/deepseek-ai/smallpond \
  Fire-Flyer File System 是一种高性能分布式文件系统，专为解决 AI 训练和推理工作负载的挑战而设计。它利用现代 SSD 和 RDMA 网络提供共享存储层，简化了分布式应用程序的开发。
* 186.【CVPR2025】具有显式3D建模的世界一致性视频扩散  专知  https://mp.weixin.qq.com/s/-V5oCgCwsuMtHL1aQZ-_5w \
  World-consistent Video Diffusion with Explicit 3D Modeling \
  https://zqh0253.github.io/wvd \
  ???怎么学习RGB与全局XYZ的联合分布的
* 187.R1-Think能力如何用于RAG及多模态场景？Rank1及R1-Onevision实现思路解析  老刘说NLP  https://mp.weixin.qq.com/s/vec5Z9VS6x_NMlDVKQLJqA 
* 188.AAAI 2025 | 通义实验室提出基于辩论的弱监督对齐强模型方法，探索超级对齐新范式  PaperWeekly  https://mp.weixin.qq.com/s/FjDmjWTJ7jHvxtSaupTeBg \
  Debate Helps Weak-to-Strong Generalization
* 189.技术方法论视角下的多样化身心框架  CreateAMind  https://mp.weixin.qq.com/s/z1f77NTlwAEsf3gRMQHhgg \
  Technological Approach to Mind Everywhere: An Experimentally-Grounded Framework for Understanding Diverse Bodies and Minds \
  合成生物学和生物工程学提供了在多种嵌合架构中创造新型具身认知系统（也可称为心智）的机会，这些架构结合了进化而来和设计而成的物质与软件。这些进步正在颠覆哲学中关于心智的熟悉概念，并要求我们以新的方式思考和比较真正多样化的智能，它们的组成和起源与任何现有的自然模型物种都不相同。在这一观点文章中，我介绍了TAME（Technological Approach to Mind Everywhere，即“心智无处不在”技术方法）——一个用于理解和操控非传统基质中认知的框架。TAME形式化了一种非二元（连续的）、基于经验的强具身主体性方法。TAME提供了一种自然的方式来思考动物感知作为一种细胞群体集体智能的实例，这种智能的动态在许多其他基质中以类似的方式表现出来。当应用于再生/发育系统时，TAME提示了一种将形态发生视为基础认知的视角。在解剖学、生理学、转录学和三维（传统行为）空间中解决问题的深度对称性推动了关于认知能力在进化过程中如何增加的具体假设。进化利用的一个重要媒介是发育性生物电，通过离子通道和缝隙连接的前神经使用，将细胞层面的反馈回路扩展到解剖学稳态，从而将活跃的亚单位连接成更大的主体。这种多尺度能力的生物系统架构对身体和心智的可塑性具有重要意义，极大地增强了可进化性。从计算科学、进化生物学和基础认知的角度审视经典和近期数据，揭示了一个富有成果的研究项目，对认知科学、进化生物学、再生医学和人工智能都有许多启示。
* 190.探索跳跃式思维链：DeepSeek创造力垫底，Qwen系列接近人类顶尖水平  机器之心  https://mp.weixin.qq.com/s/iRMkA7CJuKGsMr75ZpOWBQ \
